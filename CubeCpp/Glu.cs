		    ...
		    ref Vector3 I )
{
	...
	static public int Project (Vector3d obj, ref Vector3d win)
	{
	...
	static public int Project (Vector3d obj, Matrix4d modelMatrix, Matrix4d projMatrix, int[] viewport, ref Vector3d win)
	{
